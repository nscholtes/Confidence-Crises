...
print(gcf,'-dpdf',strcat(fig_output_VN,'interbanknetwork_initial.pdf'));

% Evolving network structure at four time points over the simulation  
figure
for i = 2:numel(Slice)
...
pos = get(gcf,'Position');
set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(gcf,'-dpdf',strcat(fig_output_VN,'interbanknetwork_evolution.pdf'));
...
pos = get(gcf,'Position');
set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(gcf,'-dpdf',strcat(fig_output_VN,'interbankloans_initial.pdf'));
...
pos = get(gcf,'Position');
set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(gcf,'-dpdf',strcat(fig_output_VN,'interbankloans_evolution.pdf'));
...
pos = get(gcf,'Position');
set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(gcf,'-dpdf',strcat(fig_output_VN,'overlappingportfolio_initial.pdf'));
